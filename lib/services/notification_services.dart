...
class NotifyHelper {
  ...
  tz.TZDateTime _nextInstanceOfTenAM(
    ...
    final tz.TZDateTime fd = tz.TZDateTime.from(formatedDate, tz.UTC);
    tz.TZDateTime scheduledDate =
        tz.TZDateTime(tz.UTC, fd.year, fd.month, fd.day, hour, minutes);
    ...
    if (scheduledDate.isBefore(now)) {
      if (repeat == 'Daily') {
        scheduledDate = tz.TZDateTime(
            tz.UTC, now.year, now.month, (formatedDate.day) + 1, hour, minutes);
      }

      if (repeat == 'Weekly') {
        scheduledDate = tz.TZDateTime(
            tz.UTC, now.year, now.month, (formatedDate.day) + 7, hour, minutes);
      }

      if (repeat == 'Monthly') {
        scheduledDate = tz.TZDateTime(tz.UTC, now.year,
